...
# model-heat.sh - given a directory, number of topics, and number of dimensions, illustrate how the topics are dispersed in a corpus; the first part to heat.py
...
HOME=`pwd`
MALLET='./lib/mallet'
MODEL="$HOME/tmp/data.mallet"
TOPICS="$HOME/tmp/topics.txt"
KEYS="$HOME/tmp/keys.txt"
HEAT="./bin/model-heat.py"
